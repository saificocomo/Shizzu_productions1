...
<head>
    ...
    <!-- Title Page-->
    <title>Auditions | ShiZzu Productions</title>
    ...
    <!-- Main CSS-->
    <link href="css/mainad.css" rel="stylesheet" media="all">
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Audition Form</h2>
                 <form action="order" method="POST" >
                 {{ @csrf_field() }}
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Full NAME" name="name" id="name">
                        </div>
                        
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Email" name="email" id="email">
                        </div>  
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Home Address" name="address" id="address">
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="gender" name="gender" id="gender">
                        </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="Height" name="height">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-3">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="Phone" name="cellno">
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="catogories" name="categories" id="name">
                        </div>
                       
                        <div class="p-t-20">
                            <button onclick="myFunction()" class="btn btn--radius btn--green" type="submit">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
...
<h5 class="widget-title">Shizzu Productions<span></span></h5>
<p>We create Amzaing Videos </p>
</div>
</div>
...
<li>
<div class="thumb-content"><a href="index">Home</a></div>   
</li>
<li>
<div class="thumb-content"><a href="videos">Videos</a></div>   
</li>
<li>
<div class="thumb-content"><a href="login">Log In</a></div>   
</li>
<li>
<li>
<div class="thumb-content"><a href="index#contact">Contact US</a></div>   
</li>
<li>
...
<p>Copyright Shizzu Productions © 2016. All rights reserved.</p>
</div>
</div>
</div>
</div>
